...
export function campaignTypeLabel(type: string | null | undefined): string {
  ...
  const map: Record<string, string> = {
    ...
    utstyr: "Utstyr",
    reise: "Reise",
    golfballer_logo: "Golfballer m/logo",
    turnering: "Turnering/cup",
    drakter_utstyr: "Drakter og utstyr",
    cupreise: "Cupreise",
    sesongstart: "Sesongstart/avslutning",
    annet_pengestotte: "Annet/pengestøtte",
    drakter: "Drakter",
    annet: "Annet",
  };
